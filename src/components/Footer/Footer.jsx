          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand-section">
              <div className="footer-brand">
                <img src={logo} alt="Alphas Creative" className="footer-logo" />
              </div>
              <p className="footer-description">
                Transforming ideas into digital reality with cutting-edge AI solutions, 
                modern web development, and innovative automation tools.
              </p>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><NavLink to="/services" className="footer-link">AI & Automations</NavLink></li>
                <li><NavLink to="/services" className="footer-link">Web Development</NavLink></li>
                <li><NavLink to="/services" className="footer-link">Mobile Development</NavLink></li>
                <li><NavLink to="/services" className="footer-link">UI/UX Design</NavLink></li>
                <li><NavLink to="/services" className="footer-link">Digital Marketing</NavLink></li>
              </ul>
            </div>
            ...
            <div className="footer-section newsletter-section">
              ...
              <p className="newsletter-description">
                Subscribe to our newsletter for the latest updates on AI innovations and tech trends.
              </p>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright-text">
              © 2025 Alphas Creative. All rights reserved.
            </p>
